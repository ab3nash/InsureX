...
public class CalculatePremiumQueryValidatorTests
{
    ...
    {
        CalculatePremiumQuery query = new(name, DateTime.Now.AddYears(-10), "Clerk", 2010);
    ...
    {
        CalculatePremiumQuery query = new("Jon Doe", DateTime.Now.AddYears(-age), "Clerk", 2010);
    ...
    {
        CalculatePremiumQuery query = new("Jon Doe", DateTime.Now.AddYears(-10), occupation, 2010);
    ...
    {
        CalculatePremiumQuery query = new("Jon Doe", DateTime.Now.AddYears(-10), "Clerk", sumInsured);
    ...
    {
        CalculatePremiumQuery query = new("Jon Doe", DateTime.Now.AddYears(-10), "Clerk", 2000);
